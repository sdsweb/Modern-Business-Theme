				...
				<p>
					<?php
						printf( '<a href="%1$s" target="_blank">%2$s</a> %3$s',
							...
							__( 'Upgrade to Modern Business Pro', 'modern-business' ),
							__( 'and receive more color schemes!', 'modern-business' )
						);
					?>
				</p>
		<?php
				...
				<p>
					<?php
						printf( '<a href="%1$s" target="_blank">%2$s</a> %3$s',
							...
							__( 'Upgrade to Modern Business Pro', 'modern-business' ),
							__( 'to use more web fonts!', 'modern-business' )
						);
					?>
				</p>
		<?php
				...
				<p>
					<?php
						printf( '<a href="%1$s" target="_blank">%2$s</a> %3$s',
							...
							__( 'Upgrade to Modern Business Pro', 'modern-business' ),
							__( 'to receive priority ticketing support!', 'modern-business' )
						);
					?>
				</p>
		<?php
...
function sds_get_pro_link( $content ) {
	return esc_url( 'https://slocumthemes.com/wordpress-themes/modern-business-pro/?utm_source=modern-business&utm_medium=link&utm_content=' . urlencode( sanitize_title_with_dashes( $content ) ) . '&utm_campaign=pro#purchase-theme' );
}
