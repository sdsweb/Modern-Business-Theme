...
if ( ! function_exists( 'sds_theme_options_ads' ) ) {
	...
	function sds_theme_options_ads() {
		...
		<div class="sds-theme-options-ad">
			<a href="<?php echo esc_url( __( 'http://slocumthemes.com/wordpress-themes/modern-business/', 'modern-business' ) ); ?>" target="_blank" class="sds-theme-options-upgrade-ad">
...
if ( ! function_exists( 'sds_theme_options_upgrade_cta' ) ) {
	...
	function sds_theme_options_upgrade_cta( $type ) {
		switch( $type ) :
			...
			case 'web-fonts':
				?>
				<p><?php printf( __( '<a href="%1$s">Upgrade to Modern Business Pro</a> to use more web fonts!', 'modern-business' ), esc_url( 'http://slocumthemes.com/wordpress-themes/modern-business/' ) ); ?></p>
				<?php
				break;
			case 'help-support':
				?>
				<p><?php printf( __( '<a href="%1$s">Upgrade to Modern Business Pro</a> to receive priority ticketing support!', 'modern-business' ), esc_url( 'http://slocumthemes.com/wordpress-themes/modern-business/' ) ); ?></p>
				<?php
				break;
		endswitch;
	}
