	...
	?>
		<section class="sds-sitemap sitemap">
			<section class="sitemap-pages page-list">
				<h2 title="<?php esc_attr_e( 'Pages', 'modern-business' ); ?>"><?php _e( 'Pages', 'modern-business' ); ?></h2>
				<ul>
			...
			<section class="sitemap-archives sitemap-monthly-archives monthly-archives archive-list">
				<h2 title="<?php esc_attr_e( 'Monthly Archives', 'modern-business' ); ?>"><?php _e( 'Monthly Archives', 'modern-business' ); ?></h2>
				<ul>
					<?php wp_get_archives(); ?>
				</ul>
			</section>
			...
			<section class="sitemap-categories category-list">
				<h2 title="<?php esc_attr_e( 'Blog Categories', 'modern-business' ); ?>"><?php _e( 'Blog Categories', 'modern-business' ); ?></h2>
				<ul>
...
if ( ! function_exists( 'sds_archive_title' ) ) {
	function sds_archive_title() {
		...
		?>
			<h1 title="<?php esc_attr_e( 'Author Archive:', 'modern-business' ); ?> <?php echo ( $author instanceof WP_User ) ? $author->display_name : false; ?>" class="page-title author-archive-title">
				<?php _e( 'Author Archive:', 'modern-business' ); ?> <?php echo ( $author instanceof WP_User ) ? $author->display_name : false; ?>
			</h1>
		<?php
		// Categories
		elseif ( is_category() ) :
		?>
			<h1 title="<?php single_cat_title( __( 'Category Archive: ', 'modern-business' ) ); ?>" class="page-title category-archive-title">
				<?php single_cat_title( __( 'Category Archive: ', 'modern-business' ) ); ?>
			</h1>
		<?php 
		// Tags
		elseif ( is_tag() ) :
		?>
			<h1 title="<?php single_tag_title( __( 'Tag Archive: ', 'modern-business' ) ); ?>" class="page-title tag-archive-title">
				<?php single_tag_title( __( 'Tag Archive: ', 'modern-business' ) ); ?>
			</h1>
		<?php
		// Daily Archives
		elseif ( is_day() ) :
		...
		?>
			<h1 title="<?php esc_attr_e( 'Daily Archives:', 'modern-business' ); ?> <?php echo $the_date; ?>" class="page-title day-archive-title daily-archive-title">
				<?php _e( 'Daily Archives:', 'modern-business' ); ?> <?php echo $the_date; ?>
			</h1>
		<?php
		// Monthly Archives
		elseif ( is_month() ) :
		...
		?>
			<h1 title="<?php esc_attr_e( 'Monthly Archives:', 'modern-business' ); ?> <?php echo $the_date; ?>" class="page-title month-archive-title monthly-archive-title">
				<?php _e( 'Monthly Archives:', 'modern-business' ); ?> <?php echo $the_date; ?>
			</h1>
		<?php
		// Yearly Archives
		elseif ( is_year() ) :
		...
		?>
			<h1 title="<?php esc_attr_e( 'Yearly Archives:', 'modern-business' ); ?> <?php echo $the_date; ?>" class="page-title year-archive-title yearly-archive-title">
				<?php _e( 'Yearly Archives:', 'modern-business' ); ?> <?php echo $the_date; ?>
			</h1>
		<?php
		endif;
	}
...
if ( ! function_exists( 'sds_no_posts' ) ) {
	...
	?>
		<section class="no-results no-posts">
			<p><?php _e( 'We were not able to find any posts. Please try again.', 'modern-business' ); ?></p>
		</section>
	<?php
	}
}
...
if ( ! function_exists( 'sds_post_meta' ) ) {
	function sds_post_meta() {
		...
		?>
			<p>
			<?php
				printf( __( 'This entry was posted in %1$s and tagged in %2$s.', 'modern-business' ),
		...
		?>
			<p>
			<?php
				printf( __( 'This entry was posted in %1$s.', 'modern-business' ),
				get_the_category_list( ', ', 'single' ) );
			?>
			</p>
		<?php
		...
		?>
			<p>
			<?php
				printf( __( 'This entry was tagged in %1$s.', 'modern-business' ),
				get_the_tag_list( '', ', ' ) );
			?>
			</p>
		<?php
...
if ( ! function_exists( 'sds_comment' ) ) {
	function sds_comment( $comment, $args, $depth ) {
		...
		<li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
			<p><?php _e( 'Pingback:', 'modern-business' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( 'Edit', '<span class="ping-meta"><span class="edit-link">', '</span></span>' ); ?></p>
		</li>
		<?php
			break;
			default :
			...
			<article id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
				<section class="comment-author vcard">
					<section class="author-details">
						...
						<header class="comment-meta">
							<cite class="fn">
								<?php
									printf( __( '<a href="%1$s"><time datetime="%2$s" itemprop="commentTime">%3$s</time></a>', 'modern-business' ),
										esc_url( get_comment_link( $comment->comment_ID ) ),
										get_comment_time( 'c' ),
										sprintf( __( '%1$s at %2$s', 'modern-business' ), get_comment_date(), get_comment_time() )
									);
								?>

								<?php edit_comment_link( __( 'Edit', 'modern-business' ), '<span class="edit-link">', '<span>' ); ?>
							</cite>
						</header>
					</section>
				</section>
				...
				<section class="comment-content-container">
					<?php if ( $comment->comment_approved == '0' ) : ?>
						<p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'modern-business' ); ?></p>
					<?php endif; ?>
				...
				<section class="reply">
					<?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Reply', 'modern-business' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
				</section>
			</article>
		</li>
		<?php
...
function sds_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section( 'title_tagline' )->title = __( 'Logo/Site Title & Tagline', 'modern-business' );
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'content_color',
			array(
				'label'  => __( 'Content Color', 'modern-business' ),
				'section' => 'colors',
...
function sds_after_setup_theme() {
	...
	register_nav_menus( array(
		'top_nav' => __( 'Top Navigation', 'modern-business' ),
		'primary_nav' => __( 'Primary Navigation', 'modern-business' ),
		'footer_nav' => __( 'Footer Navigation', 'modern-business' )
	) );
}
...
function sds_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Primary Sidebar', 'modern-business' ),
		'id'            => 'primary-sidebar',
		'description'   => __( 'This widget area is the primary widget area.', 'modern-business' ),
	...
	// Secondary sidebar
	register_sidebar( array(
		'name'          => __( 'Secondary Sidebar', 'modern-business' ),
		'id'            => 'secondary-sidebar',
		'description'   => __( 'This widget area is the secondary widget area.', 'modern-business' ),
	...
	// Front Page Slider
	register_sidebar( array(
		'name'          => __( 'Front Page Slider', 'modern-business' ),
		'id'            => 'front-page-slider-sidebar',
		'description'   => __( '*This widget area is only displayed if a Front Page is selected via Settings > Reading in the Dashboard. Specifically formatted for Soliloquy or SlideDeck sliders.* This widget area is displayed above the content on the Front Page.', 'modern-business' ),
	...
	// Front Page
	register_sidebar( array(
		'name'          => __( 'Front Page', 'modern-business' ),
		'id'            => 'front-page-sidebar',
		'description'   => __( '*This widget area is only displayed if a Front Page is selected via Settings > Reading in the Dashboard.* This widget area is displayed below the Front Page Slider on the Front Page and will replace the Front Page content.', 'modern-business' ),
	...
	register_sidebar( array(
		'name'          => __( 'Header Call To Action', 'modern-business' ),
		'id'            => 'header-call-to-action-sidebar',
		'description'   => __( 'This widget area is used to display a call to action in the header', 'modern-business' ),
	...
	// After Posts
	register_sidebar( array(
		'name'          => __( 'After Posts', 'modern-business' ),
		'id'            => 'after-posts-sidebar',
		'description'   => __( 'This widget area is displayed below the content on single posts only.', 'modern-business' ),
	...
	// Footer
	register_sidebar( array(
		'name'          => __( 'Footer', 'modern-business' ),
		'id'            => 'footer-sidebar',
		'description'   => __( 'This widget area is displayed in the footer of all pages.', 'modern-business' ),
	...
	// Copyright
	register_sidebar( array(
		'name'          => __( 'Copyright Area', 'modern-business' ),
		'id'            => 'copyright-area-sidebar',
		'description'   => __( 'This widget area is designed for small text blurbs or disclaimers at the bottom of the website.', 'modern-business' ),
